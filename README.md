...
> Sito di dediche musicali giornaliere — clone indipendente di DDG FF Site.
...
È un clone autonomo e indipendente di DDG FF Site con:
...
2. Clicca "Condividi"
3. Aggiungi l'email del service account (la stessa usata per DDG FF Site)
